...
Le paragraphe d'avant-propos doit couvrir, en une fois et pour chaque guide (nouveau ou existant) : ce sont des éléments à valeur générale pour comprendre et s'orienter, jamais des vérités universelles à appliquer telles quelles ; chaque situation est particulière et mérite sa propre étude, pas un mode d'emploi ; pour ce qui dépasse la compréhension générale, en particulier les situations complexes, le recours à un professionnel adapté au sujet (médecin, psychologue, psychiatre, sexologue, thérapeute de couple, kinésithérapeute, etc. selon le guide) reste irremplaçable ; et ce projet est le travail personnel d'un étudiant en informatique, qui engage ses compétences de recherche et de synthèse mais jamais son avis personnel — l'objectif est d'apporter des éléments fondés sur la science récente, pas de convaincre de sa propre vision. Formulation de référence, à adapter dans le ton du guide plutôt qu'à copier mot pour mot : voir le paragraphe "Un repère, pas une vérité à suivre" présent dans chaque README de guide du dépôt.
