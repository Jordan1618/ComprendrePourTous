...
guide: "Les émotions"
chapitre: "5"
titre: "Réguler : ce qui marche et ce qui ne marche pas"
sujet: "commun"
angle: "pratique"
...
# Réguler : ce qui marche et ce qui ne marche pas
...
Autrement dit : **serrer les dents fonctionne pour l'apparence et échoue pour tout le reste**. Cela ne signifie pas qu'il faille tout exprimer partout — le point 1 existe pour ça. Cela signifie que la suppression ne doit pas être la stratégie par défaut. [La suppression expressive maintient l'activation physiologique](https://pubmed.ncbi.nlm.nih.gov/8326473/) tout en [dégradant la mémoire et la qualité perçue de l'échange](https://pubmed.ncbi.nlm.nih.gov/8326473/), un résultat répliqué expérimentalement (Gross & Levenson, « Emotional suppression: physiology, self-report, and expressive behavior », *Journal of Personality and Social Psychology*, 1993 ; vérification du 7 août 2026).
...
[Gal Sheppes et son équipe ont montré que les participants préfèrent spontanément la réévaluation face à une intensité faible à modérée, mais basculent vers la distraction quand l'intensité devient forte](https://pubmed.ncbi.nlm.nih.gov/21960251/) (Sheppes, Scheibe, Suri & Gross, « Emotion-regulation choice », *Psychological Science*, 2011 ; vérification du 14 août 2026). [La réévaluation demande de rester en contact avec l'information émotionnelle pour la réinterpréter, ce qui devient trop coûteux cognitivement quand cette information est trop intense](https://pubmed.ncbi.nlm.nih.gov/21960251/), alors que la distraction bloque l'information d'entrée en la court-circuitant.
