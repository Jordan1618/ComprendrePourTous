...
À démonter, donc, sans détour : demander de l'aide n'est pas une défaillance, c'est une compétence. Sujet développé dans [Pour Lui](<../Pour Lui/README.md>).
...
Deux conséquences. Beaucoup de femmes apprennent à convertir leur colère en tristesse ou en culpabilité, ce qui la rend inopérante — car la colère, elle, indique une limite franchie et appelle une action. Et dans le champ médical, ce préjugé produit un retard diagnostique documenté, des symptômes physiques étant attribués d'emblée à l'anxiété. Sujet développé dans [Pour Elle](<../Pour Elle/README.md>).
