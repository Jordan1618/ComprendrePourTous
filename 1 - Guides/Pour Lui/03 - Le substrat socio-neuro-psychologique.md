...
- **La récompense et la nouveauté.** Les circuits dopaminergiques répondent fortement à la nouveauté et à la résolution de problème. Cela n'excuse rien sur le plan de la fidélité, mais cela explique en partie pourquoi le mode réparateur (voir [4.5](<04 - L'architecture émotionnelle.md#4-5-le-code-viril-et-ses-regles-non-ecrites>), règle 2) est si spontané : proposer une solution active un circuit de récompense, écouter sans agir n'en active aucun.
...
**Temps 4 : la sanction de l'échec.** À l'adolescence puis à l'âge adulte, l'échec masculin est peu accompagné. On ne console pas un garçon qui rate, on lui dit de recommencer. Résultat : l'échec devient un événement identitaire (voir [4.4](<04 - L'architecture émotionnelle.md#4-4-honte-et-culpabilite-la-tache-et-l-acte>)) et non un événement d'apprentissage.
