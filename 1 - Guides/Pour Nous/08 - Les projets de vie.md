...
**L'asymétrie réelle.** Grossesse, accouchement, suites, allaitement, et — statistiquement — interruption de carrière, temps partiel, retentissement sur la retraite. Un projet d'enfant qui n'aborde pas explicitement cette asymétrie la fait porter en silence par un seul. Voir [Pour Elle](<../Pour Elle/README.md>).
