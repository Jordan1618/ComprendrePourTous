...
| [Familles recomposées](<../1 - Guides/Familles recomposees/README.md>) | [Sources — Familles recomposées](<Familles recomposées.md>) | [oui](<../1 - Guides/Familles recomposees/04 - Sources verifiables.md>) |

## Transversal

- [Numéros d'urgence et lignes d'écoute](<Urgences et ecoute.md>) — tous gratuits, avec ceux ouverts aux proches.
- [Sources et dates de vérification](<../3 - Transversal/Sources et dates de vérification.md>) — l'état de vérification guide par guide.
