...
Fichier de travail, **non publié**. Tout ce qui reste à produire, par ordre de priorité.

## 1. Sourcer chaque sous-partie — chantier principal

**Règle posée le 7 août 2026 : chaque sous-partie de chaque chapitre doit porter au minimum une source scientifique.** Aujourd'hui, plusieurs guides longs ne comptent qu'une dizaine de références pour 20 000 mots, ce qui est très insuffisant.

État par guide, à combler :
...
Fait le 8 août 2026 : les neuf guides ont désormais chacun un chapitre « Sources vérifiables » et une page dédiée dans `4 - Sources/`.
...
Fait le 18/09/2026 : guide passé de 11 à 25 chapitres (12 296 → 31 686 mots), élicitation complète appliquée, sources et notions à jour.
