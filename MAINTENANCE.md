...
Fait depuis la dernière relecture de ce fichier (13 août 2026) : la conversion des citations de Pour Elle en hyperliens (plus aucun guide au format ancien), le dégenrage partiel de Pour Lui (accords féminins neutralisés dans les passages qui s'adressent à "toi" comme partenaire ; la structure "toi = partenaire" elle-même n'a pas été réécrite, choix assumé), la conversion de tous les renvois internes du type "voir 4.4" en liens cliquables sur l'ensemble des guides, l'ajout de deux chapitres sur les émotions positives dans Les émotions, l'enrichissement du guide IST de 11 à 25 chapitres en deux passes (dépistage en pratique, résistance antibiotique, vivre avec une IST chronique, histoire de la stigmatisation, sociologie du dépistage, populations invisibilisées, puis une section dédiée d'une infection à la fois — chlamydia, gonorrhée, syphilis, HPV, hépatite B, hépatite C, trichomonase, mycoplasma genitalium — avec témoignages réels sourcés de patients et de médecins), et l'enrichissement du guide Massage professionnel de 12 à 21 chapitres (neurobiologie du toucher, preuves d'efficacité par pathologie, auto-massage, statut légal, formation et économie du métier, dérives à repérer, histoire et sociologie, éthique professionnelle, et un chapitre sur l'acceptation du premier massage donné, homme ou femme).
